	...
	public static function add_register_controls( $widget ) {
		...
		$widget->add_responsive_control(
			...
			[
				...
				'default' => 'center',
				'selectors' => [
					'{{WRAPPER}} .banae-post-title' => 'text-align: {{VALUE}};',
				],
			]
		);
		...
		$widget->add_control(
			...
			[
				...
				'default' => '#222222',
				'selectors' => [
					'{{WRAPPER}} .banae-post-title a, {{WRAPPER}} .banae-post-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$widget->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .banae-post-title',
			]
		);
